...
const ImageGallery = ({ images = [] }: ImageGalleryProps) => {
  ...
  return (
    <div className="container mx-auto sm:p-0 py-[20px]">
      <ImageModalGallery images={images} isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen}>
        <div className="flex gap-2 rounded-[16px] overflow-hidden relative">
          ...
          <div className="absolute bottom-2 right-2">
            <button 
              className="flex items-center gap-2 text-sm text-gray-700 bg-white px-3 py-1 rounded-[12px] shadow border"
