        ...
        <div className="relative">
          ...
          <div className="px-4 py-4">
            <div className="flex items-start justify-between pl-2 mb-1 h-[64px]">
              <h3 className="font-bold text-lg underline line-clamp-2 pr-2">{`${carData.Year} ${carData.Make} ${carData.Model} ${carData.Series}`}</h3>
              <Image src="/images/double_ellipse.png" alt="Double Ellipse" width={30} height={30} className="flex-shrink-0" />
            </div>
            ...
            <div className="flex justify-between items-center border-b p-2 mx-2 mb-1">
                ...
                <TooltipProvider>
                  <Tooltip>
                    ...
                    >
                      <div className="flex justify-between items-center">
                        <span className="text-sm">MSRP</span>
                        <span className="text-sm font-medium">{formattedOtherPrice}</span>
                      </div>
                      {showDiscount && (
